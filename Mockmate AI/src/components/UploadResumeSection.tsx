...
const UploadResumeSection = () => {
  ...
  try {
    ...
    if (!geminiApiKey) {
      alert("Please set your Gemini API key in the navbar before starting an interview.");
      return;
    }
    ...
    const response = await fetch("https://tranquil-achievement-production-8d9b.up.railway.app/interview/start", {
      method: "POST",
      body: formData,
      headers,
    });
    ...
    localStorage.setItem("InterviewId", data.interview_id); // Store data in localStorage
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              Upload your resume and job details to begin your mock interview.
            </p>
          </div>
